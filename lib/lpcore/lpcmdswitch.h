...
//
//      $Id: lpcmdswitch.h,v 1.1 2013/07/18 20:49:48 cvs Exp $
//
...
#ifndef LPCMDSWITCH_H
#define LPCMDSWITCH_H
...
{
 public:
  LPCmdSwitch(int argc,char *argv[],const char *modname,const char *usage);
  unsigned keys() const;
