...
//
//    $Id: lpttydevice.h,v 1.1 2013/07/18 20:49:49 cvs Exp $
//
...
#ifndef LPTTYDEVICE_H
#define LPTTYDEVICE_H
...
class LPTTYDevice : public QIODevice
{
  ...
  LPTTYDevice::Parity parity() const;
  void setParity(Parity);
  LPTTYDevice::FlowControl flowControl() const;
